# -*- coding: utf-8 -*-
"""Minimal LlamaIndex ingestion pipeline and query demo.

Install first:
    pip install llama-index-core

This demo does not call OpenAI or Hugging Face APIs. It uses LlamaIndex mock
models so you can focus on the pipeline flow in the terminal.
"""
...
def main() -> None:
    ...
    print("=== 7. Plain-English summary of what happened ===")
    print("Documents were split into nodes, nodes were embedded as vectors,")
    print("the retriever found relevant nodes, and QueryEngine used those")
    print("retrieved nodes as context to produce an answer.")
